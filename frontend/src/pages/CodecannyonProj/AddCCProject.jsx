...
const apiUrl = "http://localhost:8070/CCProjects/addCCProject"; // Change to your API URL
...
const validationSchema = Yup.object({
  ...
  ProjectCategory: Yup.string().nullable().required("Project Category is required"),
...
export default function AddCCProject(props) {
  ...
  const { openPopupAddCCProject, setOpenPopupAddCCProject } = props;
  ...
  useEffect(() => {
    ...
    fetchCategory();
  }, [props, openPopupAddCCProject]);

  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      // Handle form submission
      await axios.post(apiUrl, values);
      sessionStorage.setItem("CCProjectCreated", "1");
      ...
      setSubmitting(false);
      setOpenPopupAddCCProject(false);
    }
  };

  return (
    <Dialog
      open={openPopupAddCCProject}
      onBackdropClick={() => setOpenPopupAddCCProject(false)}
      maxWidth="md"
        ...
        <DialogTitle>
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              <p className="popupTitle">Add CodeCannyon Project</p>
            </div>
          </div>
