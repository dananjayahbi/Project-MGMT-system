...
const apiUrl = "http://localhost:8070/CCPCategories/addCCPCategory/"; // Change to your API URL

//The Main function
export default function AddCCPCategory(props) {
  ...
  const { openPopupAddCCPCategory, setOpenPopupAddCCPCategory } = props;
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      sessionStorage.setItem("CCPCategoryCreated", "1");
      ...
      setSubmitting(false);
      setOpenPopupAddCCPCategory(false);
    }
  };

  return (
    <Dialog
      open={openPopupAddCCPCategory}
      onBackdropClick={() => setOpenPopupAddCCPCategory(false)}
      maxWidth="md"
