...
const apiUrl = "http://localhost:8070/CustomProjects/addCustomProject"; // Change to your API URL
...
export default function AddCustProject(props) {
  ...
  const { openPopupAddCustProject, setOpenPopupAddCustProject } = props;
  ...
  useEffect(() => {
    ...
    fetchCategory();
  }, [props, openPopupAddCustProject]);

  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      // Handle form submission
      await axios.post(apiUrl, values);
      sessionStorage.setItem("CustProjectCreated", "1");
      ...
      setSubmitting(false);
      setOpenPopupAddCustProject(false);
    }
  };

  return (
    <Dialog
      open={openPopupAddCustProject}
      onBackdropClick={() => setOpenPopupAddCustProject(false)}
      maxWidth="md"
        ...
        <DialogTitle>
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              <p className="popupTitle">Add Custom Project</p>
            </div>
          </div>
